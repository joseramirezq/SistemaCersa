          ...
          class="table table-striped table-bordered">
            ...
            <tbody>
              ...
              <tr>
                <td>C0001</td>
                <td>Curso</td>
                <td>GESTIÓN Y MANEJO INTEGRAL DE RESIDUOS SÓLIDOS </td>
                <td>100</td>
                <td>01/04/2019</td>
                <td class="text-danger">
                    <div class="btn-group dropdown">
                        <button type="button" class="btn btn-inverse-warning btn-sm" aria-haspopup="true"
                          aria-expanded="false" data-toggle="modal" data-target="#nodalcurestado">
                          Detalle
                        </button>
              ...
              <tr>
                  <td>C0002</td>
                  <td>Curso</td>
                  <td>PROGRAMACIÓN, METRADOS, PRESUPUESTOS</td>
                  <td>105</td>
                  <td>08/05/2019</td>
                  <td class="text-danger">
                      <div class="btn-group dropdown">
              ...
              <tr>
                  <td>C0003</td>
                  <td>Diplomado</td>
                  <td>METEOROLOGÍA APLICADA AL MONITOREO </td>
                  <td>100</td>
                  <td>01/04/2019</td>
                  <td class="text-danger">
                      <div class="btn-group dropdown">
...
<div class="modal fade" id="nodalcurestado" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
