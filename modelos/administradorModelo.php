...
class administradorModelo extends mainModel
{
    ...
    protected function agregar_administrador_modelo($datos)
    {
        ...
        usuario(idcargo,codigousuario, nombre_us,  apellidos_us, correo_us, telefono_us, usuario_us, pass_us, estado_us, permisos)
         VALUES(:Idcargo, :Codigo, :Nombre, :Apellidos, :Correo, :Telefono, :Usuario, :Pass, :Estado, :Permiso)");
